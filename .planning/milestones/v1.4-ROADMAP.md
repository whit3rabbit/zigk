...
- [x] 37-02-PLAN.md -- Sender SWS avoidance gate, post-drain window update ACK in recv()
...
- [x] 39-03-PLAN.md -- Gap closure: EINTR signal checks in MSG_WAITALL and MSG_PEEK blocking loops (API-01, API-02, API-03)
