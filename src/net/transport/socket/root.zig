...
const raw_api = @import("raw_api.zig");
...
pub const SOCK_RAW = types.SOCK_RAW;
pub const SOCK_NONBLOCK = types.SOCK_NONBLOCK;
pub const SOCK_CLOEXEC = types.SOCK_CLOEXEC;
pub const SOL_SOCKET = types.SOL_SOCKET;
pub const IPPROTO_IP = types.IPPROTO_IP;
pub const IPPROTO_ICMP = types.IPPROTO_ICMP;
pub const IPPROTO_TCP = types.IPPROTO_TCP;
pub const IPPROTO_IPV6 = types.IPPROTO_IPV6;
pub const IPPROTO_ICMPV6 = types.IPPROTO_ICMPV6;
...
pub const SO_PEERCRED = types.SO_PEERCRED;
...
pub const acquireSocket = state.acquireSocket;
pub const releaseSocket = state.releaseSocket;
...
pub const connect6 = tcp_api.connect6;
...
pub const connectAsync6 = tcp_api.connectAsync6;
...
pub const getsockname6 = control.getsockname6;
pub const getpeername6 = control.getpeername6;
